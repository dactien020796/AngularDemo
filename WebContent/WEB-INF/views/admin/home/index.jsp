...
<body ng-app="app">
	...
	<!-- Controllers -->
	<script
		src="/DemoAngular/script/admin/controllers/hangsx.controller.js"></script>
	<script
	...
	<div id="wrapper" style="height: 725px;">
		...
		<!-- Service -->
		<script
			src="/DemoAngular/script/admin/services/authentication.service.js"></script>
		<script
			src="/DemoAngular/script/admin/services/product-detail.service.js"></script>
			...
			<ul class="nav navbar-right navbar-top-links">
				<li class="dropdown"><a class="dropdown-toggle"
					data-toggle="dropdown" href="#"> <i class="fa fa-user fa-fw"></i>
						${sessionScope.admin.hoTen} <b class="caret"></b>
				</a>
					<ul class="dropdown-menu dropdown-user">
						<li><a href="admin/home/login.php?out=true"><i
			...
			<div class="navbar-default sidebar" role="navigation">
				<div class="sidebar-nav navbar-collapse">
					<ul class="nav in" id="side-menu">
						...
						<li><a ui-sref="hangsx" class="active"><i
								class="fa fa-dashboard fa-fw"></i> Quản lý hãng sản xuất</a></li>
						<li class=""><a ui-sref="sanpham"><i
